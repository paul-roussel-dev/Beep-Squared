...
class AppTheme {
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(color: colorScheme.onSurfaceVariant, width: 2),
        ),
  ...
  static ThemeData get darkTheme {
    ...
    return dayTheme.copyWith(
      ...
      appBarTheme: dayTheme.appBarTheme.copyWith(
      ...
      cardTheme: dayTheme.cardTheme.copyWith(
        surfaceTintColor: darkColorScheme.surfaceTint,
      ),
      inputDecorationTheme: dayTheme.inputDecorationTheme.copyWith(
      ...
      dialogTheme: dayTheme.dialogTheme.copyWith(
        titleTextStyle: TextStyle(
          color: darkColorScheme.onSurface,
          fontSize: 24,
          fontWeight: FontWeight.w600,
